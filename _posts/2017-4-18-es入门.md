...
![](vrimage.top/es-jpg/1.jpg)


d.安装head插件	

在es的文件夹下输入./bin/plugin install mobz/elasticsearch-head
在浏览器输入ip：9200/_plugin/head/ 显示以如下![](vrimage.top/es-jpg/2.jpg)
...
![](vrimage.top/es-jpg/5.jpg)

b.head插件在浏览器查看		

![](vrimage.top/es-jpg/4.jpg)
...
![](vrimage.top/es-jpg/7.jpg)
b.head插件删除	

![](vrimage.top/es-jpg/6.jpg)
