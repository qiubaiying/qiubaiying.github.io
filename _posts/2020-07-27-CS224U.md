...
date:       2020-07-27
author:     Zhejian Peng
header-img: img/cs224u/CS224U_Header.jpg
catalog: true
tags:
    - NLU
    - CS224U
...
<img src="./img/cs224u/浅橘猫.jpeg" alt="drawing" width="200"/>
<img src="./img/cs224u/深橘猫.jpeg" alt="drawing" width="200"/>

我们描述两只橘猫的时候，就可以用浅一点的那个只橘猫VS深色的橘猫来作区分。然而当对比的猫不是橘色的话，我们就需要描述橘色的深浅，只需要说橘猫即可。比如这样:

<img src="./img/cs224u/对比猫.jpeg" alt="drawing" width="400"/>