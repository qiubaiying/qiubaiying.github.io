...
<img src="../img/matching_dist.png" alt="drawing" width="300">
...
在NLU的运用中，如果我们要比较两个word vector我们首先要吧word vector变成一个和为1的概率分布，然后用KL divergence来比较距离。课上给出了这么一个例子。A, B, C都是变成和为1的概率分布了。

<img src="../img/KL.png" alt="drawing" width="300">
