...
## USE SRA Explorer: you can download fastq file directly

[SRA Explorer](https://sra-explorer.info/#), This tool aims to make datasets within the Sequence Read Archive more accessible.

### Step 1 Search Accession number 

### Step 2 Selected Datasets and way for downloading
...
### Step 3 Copy command into a script and run by "nohup script.sh &"

### Step 4 unzip SRR13338275.fastq.gz
