...
> 
> [我的的博客](https://lk1583880553.github.io)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[BY Blog](https://lk1583880553.github.io)搭建出来了。。。

本教程针对的是不懂技术又想搭建个人博客的小白，操作简单暴力且快速。当然懂技术那就更好了。

看看看博客的主页样式：

[![](http://upload-images.jianshu.io/upload_images/2178672-51a2fe6fbe24d1cd.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)](https://lk1583880553.github.io)

在手机上的布局：

[![](http://upload-images.jianshu.io/upload_images/2178672-d58bb45f9faedb70.jpg)](https://lk1583880553.github.io)
...
注册完成后搜索 `lk1583880553.github.io` 进入[我的仓库](https://lk1583880553.github.io)
...
这时你在在浏览器中输入 `你的Github账号名.github.io` 例如:`lk1583880553.github.io`
...
keyword: "BY, BY Blog, 刘康的博客, liukang, 刘康, H5, Web前端, Vue" #关键词
url: "https://lk1583880553.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
新加入了**简书**，`jianshu_id` 在你打开你的简书主页后的地址如：`http://www.jianshu.com/*/********`中，后面这一串数字：`********** `
...
搭建好博客之后 你可能不想直接使用 [lk1583880553.github.io](https://lk1583880553.github.io) 这么长的博客域名吧, 想换成想 [liukang.cn](http://liukang.cn) 这样简短的域名。那我们开始吧！
...
用**阿里云** app也可以注册域名，域名的价格根据后缀的不同和域名的长度而分，比如我这个 `liukang.cn` 的域名第一年才只要4元~

域名尽量选择短一点比较好记住，注意，不能选择中文域名，比如 `张三.cn` ,GitHub Pages **无法处理中文域名**，会导致你的域名在你的主页上使用。
...
一个主机记录为 `www`,代表可以解析 `www.liukang.cn`的域名
...
若本教程顺利帮你搭建了自己的个人博客，请不要 **害羞**，给我的 [github仓库](https://github.com/lk1583880553/lk1583880553.github.io) 点个 **star** 吧！

因为最近发现 Fork 不断增加，加上直接 Clone 仓库的，保守估计已经帮助几十人成功的搭建了自己的博客，~~可是 Star 却仅仅只有 **7**！可能还是做的不够好吧！~~感谢大家的Star！

### **别无他求，点个 [Star](https://github.com/lk1583880553/lk1583880553.github.io) 吧**！
