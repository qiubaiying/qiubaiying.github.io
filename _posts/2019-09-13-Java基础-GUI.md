...
- BorderLayout将整个容器的布局划分成
   - EAST、WEST、SOUTH、NORTH、CENTER，组件只能被添加到指定的区域
...
![BorderLauout缩放原则](https://github.com/Jokerboozp/Jokerboozp.github.io/raw/master/img/%E6%89%B9%E6%B3%A8%202019-09-13%20135425.png)
...
- GridLayout型布局管理器将空间划分成规则的矩形网格，每个单元格区域大小相等。租金啊被添加到每个单元格中，先从左到右填满一行后换行，再从上往下。
