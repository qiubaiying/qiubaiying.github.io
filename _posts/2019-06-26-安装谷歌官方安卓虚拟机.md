...
10、第二次打开Android Studio软件时，会提示“Missing SDK”丢失软件开发工具包，没有这个东西，虚拟机是不能运行的。我们根据向导一步一步，把SDK安装上。点击“Next”下一步。
...
11、这个时候，强烈建议把SDK的安装路径改一下，安装在空间比较大的分区，因为所有的安卓系统包都会下载到这个目录，比如改成D:\Android SDK，以后不用了，也更容易删除，腾出空间。当然，你也可以不改。然后点击“Next”.
