...
# Volley的使用
## 下载Volley
将Volley添加到项目的最简单方法是将以下依赖项添加到应用程序的build.gradle文件中：
```
dependencies {
    ...
...
```
你还可以下载Volley并添加到你项目的library中

- Git通过在命令行键入以下内容来克隆存储库：
```
git clone https://github.com/google/volley
```
- 将下载的源码作为Android library module导入你的app project
